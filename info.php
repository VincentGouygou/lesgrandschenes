...
<script charset="utf-8" type="text/javascript">
    // procédure lancée toute les secondes pour faire les vérifications ci-dessous
...
//procédure pour verifier l'email et les autres informations passées dans les inputs
...
function sendmsg(){
    ...
    let myData      = { "nomPrenom" : nomPrenom,
        ...
        // j'appelle ajax sur le fichier server.php avec la méthode GET pour lui envoyer en json myData
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.action=="msgOk"){
                ...
                // on cache le bouton pour n'envoyer qu'une fois
                document.getElementById('fbuttonsendmsg').hidden=true;
            }
        },
